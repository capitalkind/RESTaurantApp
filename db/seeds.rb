...
Food.create(name: 'Chicken Parm', description: 'Chickeny and Delicious', price: 10)
Food.create(name: 'The Big Salad', description: 'We will hand it to you', price: 11)
Food.create(name: 'Thai Chicken', description: 'Just Spicy Enough', price: 9)
Food.create(name: 'Signature Pasta', description: 'Homemade Sauce!', price: 12)
